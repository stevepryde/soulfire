...
| Character list | Partial data-backed shell | React loads/searches cursor-paged saved characters through Tauri commands with loading/error/empty states, total count chip, and read-only character detail panels. Port OG card art, create, editor, and chat entry behavior. |
