...
| Worlds home | Partial data-backed shell | React loads in-progress adventures and searchable, cursor-paged world blueprints through Tauri commands with loading/error/empty states. Port OG card richness, create, and detail behavior, minus public/admin tabs. |
...
| Character list | Partial data-backed shell | React loads/searches cursor-paged saved characters through the Tauri list command with loading/error/empty states. Port OG card art, create, and detail/chat entry behavior. |
