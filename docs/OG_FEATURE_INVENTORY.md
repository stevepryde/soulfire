...
| Worlds home | Partial data-backed shell | React loads in-progress adventures plus searchable, cursor-paged world blueprints through Tauri commands with OG-style tabs/search chrome, 16:6 placeholder cards, loading/error/empty states, read-only blueprint/adventure state and message detail panels, adventure-scoped token stats, and in-app delete confirmations. Port generated cover art, card actions, create, and full editor/play entry behavior, minus public/admin tabs. |
