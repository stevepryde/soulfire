...
| Modals/toasts/confirmation/error/loading/empty states | Partial | Loading/error/empty states exist on shell panels, and token-history plus shell character/world/adventure deletion use in-app confirmation modals. Port remaining OG modal/toast patterns. |
