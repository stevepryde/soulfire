...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::builders::undo_character_builder,
            commands::builders::extract_npc,
            commands::builders::get_world_builder_state,
            commands::builders::send_world_builder_message,
            commands::builders::undo_world_builder,
            ...
            commands::drafts::get_chat_draft,
            commands::drafts::save_chat_draft,
            commands::drafts::clear_chat_draft,
            commands::drafts::get_adventure_draft,
            commands::drafts::save_adventure_draft,
            commands::drafts::clear_adventure_draft,
            commands::characters::count_characters,
            ...
            commands::worlds::count_world_blueprints,
